...
part 'cancel_friendship_request_usecase_provider.g.dart';

/// Provides [CancelFriendshipRequestUsecase].
@riverpod
CancelFriendshipRequestUsecase cancelFriendshipRequestUsecase(Ref ref) {
  final FriendshipsRepository repository = ref.watch(
    friendshipsRepositoryProvider,
  );
  return CancelFriendshipRequestUsecase(repository: repository);
}
