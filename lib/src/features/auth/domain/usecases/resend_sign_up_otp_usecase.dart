...
/// Usecase: resend a sign-up OTP.
final class ResendSignUpOtpUsecase {
  /// Creates the usecase.
  const ResendSignUpOtpUsecase({
  ...
  Future<void> call({
    ...
    return _authRepository.resendSignUpOtp(
      email: email,
