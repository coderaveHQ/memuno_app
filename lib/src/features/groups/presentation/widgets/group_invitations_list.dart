...
import 'package:memuno_app/src/features/groups/presentation/widgets/group_invitation_list_item.dart';
import 'package:riverpod_annotation/riverpod_annotation.dart';

/// Typed async list wrapper for incoming group invitations.
class MAsyncGroupInvitationsList extends StatelessWidget {
  const MAsyncGroupInvitationsList({
    super.key,
    this.provider,
  ...
  Widget build(BuildContext context) {
    return MAsyncList<GroupInvitationItemEntity, ListCursorEntity>(
      provider: provider ?? groupInvitationsListProvider,
      emptyText: emptyText,
      ...
      itemBuilder:
          (BuildContext context, GroupInvitationItemEntity invitation) {
            return GroupInvitationListItem(invitation: invitation);
          },
    );
  }
}
