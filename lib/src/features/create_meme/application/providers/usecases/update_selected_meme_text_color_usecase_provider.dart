...
part 'update_selected_meme_text_color_usecase_provider.g.dart';

/// Provides the [UpdateSelectedMemeTextColorUsecase] usecase.
@riverpod
UpdateSelectedMemeTextColorUsecase updateSelectedMemeTextColorUsecase(Ref ref) {
  ...
  return UpdateSelectedMemeTextColorUsecase(
