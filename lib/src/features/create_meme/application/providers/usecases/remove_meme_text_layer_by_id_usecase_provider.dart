...
part 'remove_meme_text_layer_by_id_usecase_provider.g.dart';

/// Provides the [RemoveMemeTextLayerByIdUsecase] usecase.
@riverpod
RemoveMemeTextLayerByIdUsecase removeMemeTextLayerByIdUsecase(Ref ref) {
  ...
  return RemoveMemeTextLayerByIdUsecase(
