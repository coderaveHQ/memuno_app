...
part 'select_meme_text_layer_usecase_provider.g.dart';

/// Provides the [SelectMemeTextLayerUsecase] usecase.
@riverpod
SelectMemeTextLayerUsecase selectMemeTextLayerUsecase(Ref ref) {
  ...
  return SelectMemeTextLayerUsecase(
