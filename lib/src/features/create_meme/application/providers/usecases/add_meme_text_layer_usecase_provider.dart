...
part 'add_meme_text_layer_usecase_provider.g.dart';

/// Provides the [AddMemeTextLayerUsecase] usecase.
@riverpod
AddMemeTextLayerUsecase addMemeTextLayerUsecase(Ref ref) {
  ...
  return AddMemeTextLayerUsecase(repository: repository, validator: validator);
}
