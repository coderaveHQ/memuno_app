...
part 'list_meme_laughs_usecase_provider.g.dart';

/// Provides [ListMemeLaughsUsecase].
@riverpod
ListMemeLaughsUsecase listMemeLaughsUsecase(Ref ref) {
  final MemeDetailsRepository repository = ref.watch(
    memeDetailsRepositoryProvider,
  );
  return ListMemeLaughsUsecase(repository: repository);
}
