...
import 'package:memuno_app/src/features/user_details/presentation/widgets/user_details_other_sent_memes_list_item.dart';

/// List view for other\-sent user-details memes.
class UserDetailsOtherSentMemesListView extends StatelessWidget {
  /// Creates the list view.
  const UserDetailsOtherSentMemesListView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    >(
      provider: userDetailsOtherSentMemesListProvider(userId),
      emptyText: l10n.userDetailsOtherSentMemesEmpty,
      ...
      itemBuilder:
          (
            ...
            return UserDetailsOtherSentMemesListItem(
              item: item,
              userId: userId,
            );
          },
