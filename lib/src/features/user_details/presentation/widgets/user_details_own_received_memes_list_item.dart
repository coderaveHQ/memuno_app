...
/// Card widget for rendering one own\-received user-details meme item.
class UserDetailsOwnReceivedMemesListItem extends ConsumerWidget {
  /// Creates one own\-received user-details meme card.
  const UserDetailsOwnReceivedMemesListItem({super.key, required this.item});

  /// own\-received list payload to render.
  final UserDetailsOwnReceivedMemesListPageItemEntity item;
