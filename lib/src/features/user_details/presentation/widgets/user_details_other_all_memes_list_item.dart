...
/// Card widget for rendering one other\-all user-details meme item.
class UserDetailsOtherAllMemesListItem extends ConsumerWidget {
  /// Creates one other\-all user-details meme card.
  const UserDetailsOtherAllMemesListItem({
    super.key,
    required this.item,
    required this.userId,
  });

  /// other\-all list payload to render.
  final UserDetailsOtherAllMemesListPageItemEntity item;
