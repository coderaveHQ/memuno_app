...
/// Card widget for rendering one other\-received user-details meme item.
class UserDetailsOtherReceivedMemesListItem extends ConsumerWidget {
  /// Creates one other\-received user-details meme card.
  const UserDetailsOtherReceivedMemesListItem({
    super.key,
    required this.item,
    required this.userId,
  });

  /// other\-received list payload to render.
  final UserDetailsOtherReceivedMemesListPageItemEntity item;
