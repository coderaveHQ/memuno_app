...
part 'list_user_details_other_received_memes_usecase_provider.g.dart';

/// Provides [ListUserDetailsOtherReceivedMemesUsecase].
@riverpod
ListUserDetailsOtherReceivedMemesUsecase
listUserDetailsOtherReceivedMemesUsecase(Ref ref) {
  final UserDetailsRepository repository = ref.watch(
    userDetailsRepositoryProvider,
  );
  return ListUserDetailsOtherReceivedMemesUsecase(repository: repository);
}
