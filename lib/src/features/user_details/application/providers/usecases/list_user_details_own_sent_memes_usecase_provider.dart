...
part 'list_user_details_own_sent_memes_usecase_provider.g.dart';

/// Provides [ListUserDetailsOwnSentMemesUsecase].
@riverpod
ListUserDetailsOwnSentMemesUsecase listUserDetailsOwnSentMemesUsecase(Ref ref) {
  final UserDetailsRepository repository = ref.watch(
    userDetailsRepositoryProvider,
  );
  return ListUserDetailsOwnSentMemesUsecase(repository: repository);
}
