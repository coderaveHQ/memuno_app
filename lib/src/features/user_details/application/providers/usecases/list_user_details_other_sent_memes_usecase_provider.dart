...
part 'list_user_details_other_sent_memes_usecase_provider.g.dart';

/// Provides [ListUserDetailsOtherSentMemesUsecase].
@riverpod
ListUserDetailsOtherSentMemesUsecase listUserDetailsOtherSentMemesUsecase(
  Ref ref,
) {
  final UserDetailsRepository repository = ref.watch(
    userDetailsRepositoryProvider,
  );
  return ListUserDetailsOtherSentMemesUsecase(repository: repository);
}
