...
/// List view for memes sent by auth user to one group.
class GroupDetailsMemesSentByMeListView extends StatelessWidget {
  const GroupDetailsMemesSentByMeListView({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return MAsyncMemeList(
      provider: groupDetailsMemesSentByMeListProvider(groupId),
      emptyText: l10n.groupDetailsMemesSentByMeEmpty,
