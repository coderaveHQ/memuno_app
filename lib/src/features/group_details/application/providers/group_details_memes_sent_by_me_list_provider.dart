...
import 'package:memuno_app/src/features/group_details/application/providers/usecases/list_group_details_memes_sent_by_me_usecase_provider.dart';
...
part 'group_details_memes_sent_by_me_list_provider.g.dart';

/// Async paginated controller for group memes sent by auth user.
@Riverpod(keepAlive: true)
class GroupDetailsMemesSentByMeList extends _$GroupDetailsMemesSentByMeList
    with
  ...
  Future<PaginatedPage<MemeItemEntity, ListCursorEntity>> loadPage({
    ...
    final ListGroupDetailsMemesSentByMeUsecase usecase = ref.watch(
      listGroupDetailsMemesSentByMeUsecaseProvider,
    );
