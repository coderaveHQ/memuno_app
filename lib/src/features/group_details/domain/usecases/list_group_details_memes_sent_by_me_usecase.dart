...
/// Usecase for listing memes sent by auth user to one group.
final class ListGroupDetailsMemesSentByMeUsecase {
  const ListGroupDetailsMemesSentByMeUsecase({
  ...
  Future<ListPageEntity<MemeItemEntity>> call({
    ...
    return _repository.listGroupDetailsMemesSentByMe(
      groupId: groupId,
      limit: limit,
      cursor: cursor,
    );
