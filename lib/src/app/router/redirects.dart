    ...
    <bool, _AuthRoutingPolicy>{
      ...
      true: _AuthRoutingPolicy(
        ...
        allowedRouteNames: <String>{
          ...
          GroupsRoute.routeName,
          GroupDetailsRoute.routeName,
          GroupDetailsInfoRoute.routeName,
          GroupCreateNameSheetRoute.routeName,
          GroupCreateMembersSheetRoute.routeName,
